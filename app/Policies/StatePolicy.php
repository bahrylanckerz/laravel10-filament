...
class StatePolicy
{
    ...
    {
        if ($user->hasRole('Admin') || $user->hasPermissionTo('View State')) {
            return true;
        }
        return false;
    }
    ...
    {
        if ($user->hasRole('Admin') || $user->hasPermissionTo('Create State')) {
            return true;
        }
        return false;
    }
    ...
    {
        if ($user->hasRole('Admin') || $user->hasPermissionTo('Update State')) {
            return true;
        }
        return false;
    }
    ...
    {
        if ($user->hasRole('Admin') || $user->hasPermissionTo('Delete State')) {
            return true;
        }
        return false;
    }
